...
public class CircuitTest extends TestCase {
    ...
    public void testX1andX2() {
        ...
        Circuit.Element res = Circuit.and(x1, x2);
        
        x1.assignValue(false);
        x2.assignValue(true);
    ...
    public void testX1andX2orX3() {
        Circuit.Variable x1 = Circuit.var();
        Circuit.Variable x2 = Circuit.var();
        Circuit.Variable x3 = Circuit.var();

        Circuit.Element res = Circuit.or(Circuit.and(x1, x2), x3);
        
        x1.assignValue(false);
        x2.assignValue(true);
        x3.assignValue(false);
        assertFalse(res.result());
        
        x1.assignValue(false);
        x2.assignValue(false);
        x3.assignValue(true);
        assertTrue(res.result());
    }
    /** 
    ...
    public void testAlwaysTrue() {
        ...
        Circuit.Element res = Circuit.or(x1, Circuit.not(x1));
